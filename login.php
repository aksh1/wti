...
<html lang="en">
  <head>
    ...
    <title>Login - Write To Information</title>
		...
		<div class="col-sm-2"></div>
                    	...
                    	<div class="col-sm-8">
                            ...
                            <div class="form-bottom">
			                    <form role="form" action="index.html" method="post" class="registration-form">
			                    	<div class="form-group">
			                    		<label class="sr-only" for="form-username">Email id</label>
			                        	<input type="text" name="email" placeholder="username" class="form-first-name form-control" id="form-first-name">
			                        </div>
			                        <div class="form-group">
